...
CREATE TABLE IF NOT EXISTS rockygpt_v2.campus_contacts (
  ...
  source_record_key TEXT NOT NULL,
  name TEXT NOT NULL,
  type TEXT CHECK (type IN ('person', 'office')),
  title TEXT,
  status TEXT CHECK (status = 'retired'),
  ...
  contact_note TEXT,
  phone_normalization_status TEXT NOT NULL DEFAULT 'none',
...
CREATE TABLE IF NOT EXISTS rockygpt_v2.menu_items (
  ...
  vegan BOOLEAN,
  vegetarian BOOLEAN,
  label_coverage JSONB NOT NULL DEFAULT '{}'::jsonb,
